...
// ✨ NEW: Helper to safely parse stringified DB arrays
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-500">
          <span className="text-lg font-bold text-blink-dark">
            {items.length}
          </span>{" "}
      ...
      <div className="space-y-3">
        {items.map((item) => {
          // ✨ NEW: Safely parse the image array
            ...
            >
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="sm:w-40 h-32 sm:h-auto bg-gray-100 shrink-0 overflow-hidden">
                  {/* ✨ NEW: Render the parsed displayImage */}
                  {displayImage ? (
                    <img
                      src={displayImage}
                      alt=""
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                !rejectionReason.trim() || actionLoadingId === rejectTarget?.id
              }
