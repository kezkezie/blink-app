...
import { Upload, X, Sparkles, Loader2, Info, Shirt, UserCircle, FolderOpen, MessageSquare } from "lucide-react";
                ...
                {primaryPreview ? (
                    <div className="relative aspect-square rounded-xl border border-[#57707A]/40 bg-[#191D23] overflow-hidden group shadow-inner">
                        ...
                        <button
                            ...
                            className="absolute top-2 right-2 p-2 bg-red-500/90 text-white rounded-full shadow-md hover:bg-red-50 hover:scale-110 opacity-0 group-hover:opacity-100 transition-all z-20"
                        >
                            <X className="h-4 w-4" />
                        </button>
                    </div>
                ...
                <div className="relative flex-1 flex flex-col">
                    ...
                    <div className="flex flex-wrap items-center gap-2 px-4 py-3 bg-[#191D23] border-x border-b border-[#57707A]/40 rounded-b-xl shrink-0">
                        ...
                        >
                            ...
                            <option value=" [camera shutter click] ">Camera Shutter</option>
                        </select>
                        ...
                        >
                            ...
                            <option value=" Wind blowing through fabric. ">Wind Physics</option>
                        </select>
                        ...
                        {/* Dialogue Helper */}
                        <button
                            onClick={() => setPrompt((prompt || "") + '\nModel (confident, English): "Type exact dialogue here" ')}
