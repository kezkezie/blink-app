...
export type OnboardingStatus = 'pending' | 'form_submitted' | 'review' | 'approved' | 'active' | 'churned'
...
export type ScheduleStatus = 'queued' | 'posting' | 'posted' | 'failed' | 'cancelled'

export type ConversationType = 'dm' | 'comment' | 'mention' | 'story_reply'
export type ConversationStatus = 'open' | 'auto_replied' | 'escalated' | 'resolved' | 'ignored'
export type Sentiment = 'positive' | 'neutral' | 'negative' | 'urgent'
export type SenderType = 'customer' | 'ai_bot' | 'human_agent'
export type MessageDirection = 'inbound' | 'outbound'

export type AssetType = 'logo' | 'image' | 'video' | 'audio' | 'document' | 'font' | 'brand_guide'
export type StorageProvider = 'google_drive' | 'supabase' | 'cloudinary'
export type ProductAvailability = 'available' | 'out_of_stock' | 'discontinued' | 'coming_soon'
...
export interface Database {
    public: {
        Tables: {
            clients: {
                Row: Client
                Insert: Partial<Client> & Pick<Client, 'company_name' | 'contact_name' | 'contact_email'>
            ...
            social_accounts: {
                Row: SocialAccount
                Insert: Partial<SocialAccount> & Pick<SocialAccount, 'client_id' | 'platform'>
            ...
            content_schedule: {
                Row: ContentSchedule
                Insert: Partial<ContentSchedule> & Pick<ContentSchedule, 'content_id' | 'client_id' | 'platform' | 'scheduled_at'>
                Update: Partial<ContentSchedule>
            }
            conversations: {
                Row: Conversation
                Insert: Partial<Conversation> & Pick<Conversation, 'client_id' | 'platform' | 'conversation_type'>
                Update: Partial<Conversation>
            }
            conversation_messages: {
                Row: ConversationMessage
                Insert: Partial<ConversationMessage> & Pick<ConversationMessage, 'conversation_id' | 'direction' | 'message_text'>
                Update: Partial<ConversationMessage>
            }
            assets: {
                Row: Asset
                Insert: Partial<Asset> & Pick<Asset, 'client_id' | 'asset_type' | 'file_url'>
